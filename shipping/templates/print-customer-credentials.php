...
<head>
    <meta charset="UTF-8">
    <title>بيانات دخول العملاء</title>
    <style>
        ...
        .shipping-name { font-size: 24px; font-weight: 900; color: #111F35; }
...
<body>
    <div class="header">
        <div class="shipping-name"><?php echo esc_html($shipping['shipping_name']); ?></div>
        <div class="report-title">كشف بيانات دخول العملاء (ولي الأمر / العميل)</div>
